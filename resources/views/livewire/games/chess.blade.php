    ...
    @if($gameStarted)
        <div class="flex flex-wrap justify-center gap-4 text-sm">
            <div class="px-4 py-2 glass rounded-lg border border-[hsl(var(--border)/.1)]">
                ...
                @if($inCheck)
                    <x-heroicon-o-exclamation-triangle class="ml-2 w-4 h-4 text-red-400" aria-label="In check" />
                @endif
            </div>
            <div class="px-4 py-2 glass rounded-lg border border-[hsl(var(--border)/.1)]">
            ...
            <div class="grid grid-cols-3 gap-4 text-xs text-ink/60">
                ...
                <div class="flex items-center gap-2">
                    <div class="w-3 h-3 rounded-full bg-[hsl(var(--star))] border-2 border-[hsl(var(--star)/.8)] relative">
                        <div class="absolute inset-0 flex items-center justify-center text-[8px] text-[hsl(var(--space-900))] font-bold">K</div>
                    </div>
                    <span>King</span>
                </div>
            </div>

...
<a 
    ...
    {{ $attributes->merge(['class' => 'flex items-center gap-2 transition-opacity hover:opacity-90 focus-visible:outline-2 focus-visible:outline-star focus-visible:outline-offset-2 rounded ' . $class]) }}
>
    <img 
        src="{{ asset('bear.svg') }}" 
        alt=""
